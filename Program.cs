...
namespace AttendanceSystem
{
    class Program
    {
        ...
        //     // If the user exists and the password matches, return true (successful login)
        //     if (user != null && user.Password == password)
        //     {
        //         return true;
        //     }

        //     // Return false if the user doesn't exist or the password doesn't match
        //     return false;
        // }
        ...
        static User AuthenticateUser()
        {
           ...
           using (var context = new AttendanceDbContext())
           {
               ...
               Console.WriteLine(user.Username + " this is the user");
